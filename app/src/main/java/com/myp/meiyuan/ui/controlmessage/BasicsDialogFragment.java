...
public class BasicsDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.dialog_basics, container, false);
        //设置窗口以对话框样式显示
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (listener != null) {
                    listener.commit(startTimeHour.getValue() + ":" + startTimeMintue.getValue(), endTimeHour.getValue() + ":" + endTimeMintue.getValue());
                }
            }
        });
    }
